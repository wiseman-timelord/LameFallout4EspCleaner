...
Instructions:
Put the extracted files in a sensible location/folder, then put ~"FO4Edit 4.1.5f.zip" in the same folder as the scripts, then run the installer, then run the program. Use the batch for entry point, run as admin.
