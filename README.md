...
### Notation:
- You are advised to play a 1-2hr movie on the second display if you have one, allowing the autoclean to do its thing, or otherwise on single monitor computer, do some chors/housework leaving the machine alons.
